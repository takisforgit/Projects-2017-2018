# -*- coding: utf-8 -*-
"""
Created on Mon Nov 6 23:08:32 2017
@author: takis ntilios
Note : turtle.shapesize(stretch_wid=None, stretch_len=None, outline=None)
"""
import random
import turtle as t


## Create each Turtle ( for each number in the random list )
...
## Just the Axes ( for help ath the beginning )
#def Axes():
#    t.ht()
#    t.pd()
#    t.goto(-200,0)
...
for i in range(randomSize) :
    ...
    ## Choose only distinct values. Never same
...
t.up()
t.goto(-200,300)
t.write("Random list of "+str(len(sizeList))+" elements,from 1 to 20", font="Arial 20")
